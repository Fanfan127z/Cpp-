...
#### 2.1.2.2  学习Linux==多进程==的基础知识和使用方法；
...
#### 2.1.3.3  开发守护进程模块，与调度模块结合协同工作，保证服务程序永不停机。
...
### 2.1.5  服务程序运行的策略（即启动我们工作中==开发项目的流程==如下，这是非常重要的技能）
...
==然后增加可执行权限 ：chmod +x /etc/rc.d/rc.local== 
...
# 第三章(我应该总结我每一章学习的知识点，然后放到我自己都博客上面去，当然，我应该设置为私有的！这是我自己学到的东西)
